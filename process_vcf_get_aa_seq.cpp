...
"       --anc-from-maf                          ANCESTRAL_WITH_GAPS.fa is not from 'prequel' but rather a sequence for a specific species\n"
...
static const struct option longopts[] = {
    ...
    { "anc-from-maf",   no_argument, NULL, OPT_ANC_FROM_MAF },
    ...
    *outAncestralFile << line << std::endl;
    ...
    if (!opt::bAncFromMaf) {
        ...
        for (string::size_type i = 0; i != refFastaSeq.length(); i++) {
            ...
            else if (ancWithGapsSeq[i] == '-') { outAncestralSeq += refFastaSeq[i]; }
...
void parseAaSeqOptions(int argc, char** argv) {
    ...
    for (char c; (c = getopt_long(argc, argv, shortopts, longopts, NULL)) != -1;)
    {
        ...
        switch (c)
        {
            ...
            case OPT_ANC_FROM_MAF: opt::bAncFromMaf = true; break;
            case 'h':
